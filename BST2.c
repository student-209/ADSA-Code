...
// Function to make the entire tree empty
...
// Function to display the BST using the selected traversal method
...
int main()
{
    ...
    while (1)
    {
        ...
        case 7:
            makeEmpty(root);
            root = NULL; // Set root to NULL after freeing all nodes
